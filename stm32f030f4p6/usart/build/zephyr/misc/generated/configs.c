...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0x8000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MP_MAX_NUM_CPUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 640);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IDLE_STACK_SIZE, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ISR_STACK_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32F030_DEMO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32F030_DEMO_STM32F030X6, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32F030X4, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 4);
